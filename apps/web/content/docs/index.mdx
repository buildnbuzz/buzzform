...
#### Install all field components and core packages via shadcn registry
...
<Callout type="info">
  Add `"@buzzform": "https://form.buildnbuzz.com/r/{name}.json"` to the
  `registries` field in your `components.json` first. See
  [Installation](/docs/installation) for full setup details.
</Callout>
