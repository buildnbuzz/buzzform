...
- Core packages (`@buildnbuzz/form-react`, `@buildnbuzz/form-react`, TanStack Form)
...
```bash
pnpm add @buildnbuzz/form-react @buildnbuzz/form-react @tanstack/react-form @tanstack/form-core
```
