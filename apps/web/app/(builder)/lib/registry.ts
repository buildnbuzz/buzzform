...
import { checkboxGroupFieldProperties } from "./properties/checkbox-group";
...
export const builderFieldRegistry: BuilderFieldRegistry = {
  ...
  "checkbox-group": {
    ...
    properties: checkboxGroupFieldProperties,
  },
  switch: {
    kind: "data",
  ...
  collapsible: {
    ...
    renderer:
      CollapsibleLayout as unknown as ComponentType<BuilderNodeRendererProps>,
