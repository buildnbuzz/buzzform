...
/** Property editor config for `text` fields. */
    ...
    tabs: [
      {
        ...
        fields: [
          ...
          { type: "text", name: "autoComplete", label: "Auto Complete", description: "HTML autocomplete attribute", placeholder: "email, name, tel" },
