...
/** Property editor config for `switch` fields. */
    ...
    tabs: [
      {
        ...
        fields: [
          ...
          { type: "text", name: "label", label: "Label", description: "Display label next to the switch" },
      ...
      },
      {
        label: "Validation",
        fields: [
          { type: "switch", name: "required", label: "Required", description: "User must toggle this on", ui: { alignment: "between" } },
        ],
      },
    ],
  },
